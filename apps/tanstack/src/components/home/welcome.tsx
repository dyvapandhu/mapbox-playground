...
const cards = [
  ...
  },
  {
    ...
    description: 'Deploy a full-stack Start app with a simple Vite build + Node server entry.',
    ...
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="rounded-2xl border bg-card p-8 shadow-sm">
        <div className="flex flex-col gap-2">
          ...
          <h1 className="font-semibold text-3xl tracking-tight">Zero One Starter Kit</h1>
          <p className="max-w-2xl text-muted-foreground">
            A minimal, full-stack TanStack Start app template wired with TanStack Router file-based
            routing, Tailwind v4, tests, and Docker.
          </p>
        </div>
      </div>
